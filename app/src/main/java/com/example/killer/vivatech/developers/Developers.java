...
import com.example.killer.vivatech.PagerSlidingTabStrip;
...
public class Developers extends AppCompatActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    int[] photos={R.drawable.photo1,R.drawable.photo5,R.drawable.photo9,R.drawable.photo10,};
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = {"Guide","Vrajesh", "Divyesh", "Vishal"};
